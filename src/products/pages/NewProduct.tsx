...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      title: 'Camisa',
      price: 50.25,
      description: 'lorenmidaoifafijaoifjafaoifuaougaougau',
      category: "men's clothing",
      image: 'https://mivestidorazul.es/1496-camisa-manga-corta-hombre-marron.html'
    }
  });

  // cuando tenemos un url que aparezca la imagen del artículo. podemos utilizar la función watch
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input value={field.value} onChange={field.onChange}
                  className="mt-2"
                  type="text" label="Titulo del producto"
                />
              )}
            />
