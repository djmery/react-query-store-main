...
export const ProductCard = ({ product, fullDescription = false, prefetchProduct }: Props) => {
  return (
    //como prefetchProduct puede ser undefined se le pregunta si venen, si se cumple la condición si es diferente de null o undefined ejecuta prefetchProduct(product.id)
